function CRBahrain() {
  return (
    <div className="mb-8 mt-6 mx-3 md:mx-auto xl:max-w-[1080px] md:max-w-[1000px]">
      ...
      <p className="text-gray-700">
        This classification system ensures Bahrain&apos;s economic interests are
        considered when registering businesses.
      </p>
    </div>
  );
}
